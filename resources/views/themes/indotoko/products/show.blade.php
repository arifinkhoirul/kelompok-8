                ...
                <div id="product-images" class="carousel slide" data-ride="carousel">
                    ...
                    <ol class="carousel-indicators list-inline">
                        <li class="list-inline-item active"> <a id="carousel-selector-0" class="active"
                                data-bs-slide-to="0" data-bs-target="#product-images"> <img src="{{ asset('img/1.jpg') }}"
                ...
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="product-select mt-3 row justify-content-start g-2 align-items-center">
                        ...
                        <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                            <button type="button" class="btn btn-add-cart"><i class="bx bx-cart-alt"></i> Add to
                                cart</button>
                        </div>
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-product-details-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="nav-product-details" aria-selected="true">Details</button>
                        <button class="nav-link" id="nav-product-reviews-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="nav-product-reviews" aria-selected="false">Reviews</button>
                    </div>
                </nav>
